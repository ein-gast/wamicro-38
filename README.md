...
Формальный критерий успеха: упаковать небольшой проект в виде data-url и не выйти за 4096 байт (предельный размер сообщения в Telegram).
...
Итог сбоки только **build/app_Z.html** и **build/app_Z.url2.md**, остальное нужно только в при разработке.
